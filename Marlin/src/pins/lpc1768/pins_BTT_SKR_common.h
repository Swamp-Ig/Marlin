...
// Artifactory PW: the Temp 0 circuitry appears to be borked somehow.
// Have pin swapped with Temp 1 sensor.
#ifndef TEMP_0_PIN
  #define TEMP_0_PIN                    P0_25_A2 // P0_24_A1  // A1 (T1) - (68) - TEMP_0_PIN
#endif
#ifndef TEMP_1_PIN
  #define TEMP_1_PIN                    P0_24_A1 // P0_25_A2  // A2 (T2) - (69) - TEMP_1_PIN
#endif
#ifndef TEMP_BED_PIN
